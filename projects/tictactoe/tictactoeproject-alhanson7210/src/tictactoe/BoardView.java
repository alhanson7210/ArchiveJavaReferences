...
/**
 * Board view that displays the game live
 */
class BoardView extends LineList {
    ...
    /**
     * Instantiating a board view from its constructor using the given rows and columns for a board
     * @param rows rows needed to create a board
     * @param columns columns needed to create a board
     */
    ...
    /**
     * Displaying a marker on a given cell
     * @param cell a given cell
     * @return a marker Omarker or Xmarker
     */
    ...
    /**
     * resetting the winline back to null and deleting the line
     */
    void resetWinner() {
        if (winLine != null) {
            winLine.delete();
